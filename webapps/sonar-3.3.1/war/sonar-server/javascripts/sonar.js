...
},modalForm:function(){return this.each(function(){var B=A(this);
B.submit(function(C){A("input[type=submit]",this).attr("disabled","disabled");
A.ajax({type:"POST",url:B.attr("action"),data:B.serialize(),success:function(D){location.reload()
},error:function(E,F,D){A("#modal").html(E.responseText)
}});
return false
})
})
